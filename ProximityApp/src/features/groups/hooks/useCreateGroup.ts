    ...
    async (
      ...
      try {
        ...
        const groupData: Omit<Group, 'id'> = {
          ...
          activeMembers: 0, // Will be calculated later
          popularityScore: 0, // Initial score, will be calculated later
          // locationCenter can be set later based on member locations
        };
